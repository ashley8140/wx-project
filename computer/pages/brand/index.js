...
var GetSerial = function (brandId) {
    return Store('http://p6e5hhlwb.bkt.clouddn.com/wx_productModel/data/serialData.json', {
        brandId: brandId
...
Page({
    ...
    tabBrand: function (e) {
        ...
        wx.navigateTo({
            url: '/pages/serial/index?computerId=' + computerId + '&computerName='+computerName + '&computerImg=' + computerImg
        });
    },
